...
from LatentCultureClassifier.LatentCultureClassifier import LatentCultureClassifier
from LatentCultureClassifier.LatentDataset import LatentDataset
...
def train():
    ...
    # ContrastiveVAE2 hyperparameters
    '''
    batch_size, embed_dim, hidden_dim_encoder, hidden_dim_decoder, num_layers_encoder, num_layers_decoder, latent_dim, lr, epochs, beta_max, n_epochs_ramp_up = 512, 64, 64, 32, 2, 1, 128, 0.0015, 100, 0.005, 5
    # free_bits = 0.05
    # n_cycles, ratio = 4, 0.5
    ...
    classifier = LatentCultureClassifier(latent_dim, hidden_dim, number_of_cultures)
    ...
    for epoch in range(epochs_classifier):
        ...
        with torch.no_grad():
            ...
            if avg_val_loss < best_loss:
                ...
                classifier_name = f'LatentCultureClassifier/models/best_model_bs{batch_size}_hd{hidden_dim}_lr{lr_classifier}_ep{epochs_classifier}.pt'
